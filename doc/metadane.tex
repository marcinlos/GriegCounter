...
\IncludeUML{metadata_interface}{Interfejs pobierania metadanych (pewne operacje
z \texttt{ExtractionContext} zostały pominięte, dla zwiększenia czytelności)}
...
\IncludeUML[\textwidth]{metadata_interface_seq}
