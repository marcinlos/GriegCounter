...
\subsection{Tworzenie drzewa z użyciem klasy \code{Pipeline}}
...
(\code{\_}), bądź kreską (\code{-}) - np. \code{moj\_wezel.super-a/12}.  Poniższe dwie linijki są
równoważne:
...
Framework oferuje klasę \code{HammingSegmenter}, stosującą do tego celu \emph{okno Hamminga}.
