...
public class DecoderManager {
    ...
    /**
     * Returns a set of parsers declaring themselves as capable of parsing file
     * formats often used with {@code ext} as extension.
     * 
     * @param ext
     *            File extension
     * @return set of potentially compatible parsers
     * @see #getByExtension(File)
     */
    public Set<AudioFormatParser> getByExtension(String ext) {
    ...
    /**
     * Returns a set of parsers declaring potentially being capable of parsing
     ...
     */
    public Set<AudioFormatParser> getByExtension(File file) {
